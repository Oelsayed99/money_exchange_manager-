...
class HandleInertiaRequests extends Middleware
{
     ...
     * @var list<string>
     */
    private const CLIENT_GROUPS = ['common', 'nav', 'auth', 'currencies', 'settings', 'accounts', 'counterparties', 'transactions', 'statements', 'dashboard', 'reconciliations', 'movements', 'audit'];
