    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                ...
                // Pdo\Mysql::ATTR_SSL_CA, which only exists from PHP 8.4. The ternary
                // evaluates one branch only, so the deprecated name is never touched
                // on 8.4+ and the constant still resolves on 8.3.
